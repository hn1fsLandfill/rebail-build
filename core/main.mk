...
required_version := "17.x"
required_javac_version := "17"
java_version := $(shell echo '$(java_version_str)' | grep 'openjdk .*[ "]17[\. "$$]')
javac_version := $(shell echo '$(javac_version_str)' | grep '[ "]17[\. "$$]')
